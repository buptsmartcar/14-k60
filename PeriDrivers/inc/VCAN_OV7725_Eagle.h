...
#define camera_get_img_fullfps()        ov7725_eagle_get_img_fullfps()
#define camera_get_img_halffps()      ov7725_eagle_get_img_halffps()
...
extern  void    ov7725_eagle_get_img_fullfps(void);
extern  void    ov7725_eagle_get_img_halffps(void);
